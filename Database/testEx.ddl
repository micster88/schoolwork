...
ALTER TABLE Relation_14 ADD CONSTRAINT Relation_14_PK PRIMARY KEY ( SPONSOR_SPONSOR_ID, PRODUCTION_PRODUCTION_ID ) ;
...
ALTER TABLE Relation_3 ADD CONSTRAINT Relation_3_PK PRIMARY KEY ( CAST_CAST_ID, PRODUCTION_PRODUCTION_ID ) ;
