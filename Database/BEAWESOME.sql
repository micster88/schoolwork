...
--Sponsors Insert
INSERT INTO SPONSOR VALUES('Cool Guy', '30.00', 0);
INSERT INTO SPONSOR VALUES('My Dude', '50.00', 1);
INSERT INTO SPONSOR VALUES('Name Me', '15.00', 2);

--SponsoredBy Insert
INSERT INTO SPONSORED_BY VALUES(0,2);
INSERT INTO SPONSORED_BY VALUES(1, 0);
INSERT INTO SPONSORED_BY VALUES(2, 2);

--Cast Insert
INSERT INTO CAST VALUES('Romeo', 1, 0);
INSERT INTO CAST VALUES('Ernest',0, 1);
INSERT INTO CAST VALUES('Juliet',2, 2);

--Cast_In Insert
INSERT INTO CAST_IN VALUES(0, 2);
INSERT INTO CAST_IN VALUES(2, 2);
INSERT INTO CAST_IN VALUES(1, 3);

--Specialist Insert
INSERT INTO SPECIALIST VALUES(0,'Blob', 'Blobby', '60.00');
INSERT INTO SPECIALIST VALUES(1,'Spec', 'Al', '20.00');
INSERT INTO SPECIALIST VALUES(2,'Out', 'OfNames', '5.00');

--Job Insert
INSERT INTO JOB VALUES('Lighting', 2, 0);
INSERT INTO JOB VALUES('Set Design', 3, 1);
INSERT INTO JOB VALUES('Audio Setup', 2, 2);
INSERT INTO JOB VALUES('Setup Stuff', 3, 3);
INSERT INTO JOB VALUES('Stuff', 1,4);
INSERT INTO JOB VALUES('Hard Stuff', 0, 5);

--Working_Mem Insert
INSERT INTO WORKING_MEM VALUES(4, 0);
INSERT INTO WORKING_MEM VALUES(3, 5);
INSERT INTO WORKING_MEM VALUES(6, 3);

--Working_Mem Insert 
INSERT INTO WORKING_SPEC VALUES(4, 0);
INSERT INTO WORKING_SPEC VALUES(1, 1);
INSERT INTO WORKING_SPEC VALUES(2, 2);

--Sale Insert 
INSERT INTO SALE VALUES(0, '1-JAN-16');
INSERT INTO SALE VALUES(1, '12-DEC-15');
INSERT INTO SALE VALUES(2, '20-NOV-15');
INSERT INTO SALE VALUES(3, '2-FEB-16');
INSERT INTO SALE VALUES(4, '3-MAR-16');
INSERT INTO SALE VALUES(5, '2-JAN-16');
INSERT INTO SALE VALUES(6, '3-JAN-16');
INSERT INTO SALE VALUES(7, '7-JAN-16');
INSERT INTO SALE VALUES(8, '12-JAN-16');

--Ticket Insert
INSERT INTO TICKET VALUES(0, '5.00', 'Z34', 2, 0);
INSERT INTO TICKET VALUES(1, '20.00', 'M16', 3, 1);
INSERT INTO TICKET VALUES(2, '100.00', 'I13', 1, 2);
INSERT INTO TICKET VALUES(3, '75.00', 'J02', 2, 3);
INSERT INTO TICKET VALUES(4, '200.00', 'A20', 1, 4);
INSERT INTO TICKET VALUES(5, '75.00', 'K23', 0, 5);
INSERT INTO TICKET VALUES(6, '10.00', 'Y14', 3, 6);
INSERT INTO TICKET VALUES(7, '25.00', 'L15', 0, 7);
INSERT INTO TICKET VALUES(8, '150.00', 'D15', 3, 8);
INSERT INTO TICKET VALUES(9, '200.00', 'A21', 1, NULL);

--PATRON INSERTS
INSERT INTO PATRON VALUES(0, 'More', 'Fake', ' 18 Fake St', 'Fakery', 'NC', '45698', NULL);
INSERT INTO PATRON VALUES(1, 'Out', 'Ideas', '20 Out Ave', 'Idea', 'NC', '48935', NULL);
INSERT INTO PATRON VALUES(2, 'Any', 'Thing', '88 Anywhere Ave', 'Far Far Away', 'NC', '58963', NULL);
INSERT INTO PATRON VALUES(3, 'Some', 'One',  '4 Somewhere Lane', 'Someplace', 'NC', '89564', NULL);
INSERT INTO PATRON VALUES(4, 'Enough', 'Names', '7 Cant Do It St', 'Awe', 'NC', '45892', NULL);
INSERT INTO PATRON VALUES(5, 'Rando', 'Generator', '78 Not Working Ave', 'Broken', 'NC', '21467', NULL);

--BUYER INSERTS
INSERT INTO BUYER VALUES(0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0);
INSERT INTO BUYER VALUES(1, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1);
INSERT INTO BUYER VALUES(2, NULL, NULL, NULL, NULL, NULL, NULL, 2, 2);
INSERT INTO BUYER VALUES(3, NULL, NULL, NULL, NULL, NULL, NULL, 3, 3);
INSERT INTO BUYER VALUES(4, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4);
INSERT INTO BUYER VALUES(5, 'Not', 'Patron', '12 New St', 'Blah', 'NC', '32456', 5, NULL);
INSERT INTO BUYER VALUES(6, 'No', 'Imagination', '12 Adulthood Ln', 'Ah', 'NC', '57645', 6, NULL);
INSERT INTO BUYER VALUES(7, 'Wee', 'Boo', ' 6 Noobs Ave', 'Noobs', 'NC', '56425', 7, NULL);
INSERT INTO BUYER VALUES(8, 'Peanut', 'Butter', '8 Last Name Rd', 'YES', 'NC', '48956', 8, NULL);

--Adding the Buyer ID To Patron
UPDATE PATRON
SET BUYER_BUYER_ID=0 WHERE PATRON_ID=0;

UPDATE PATRON
SET BUYER_BUYER_ID=1 WHERE PATRON_ID=1;

UPDATE PATRON
SET BUYER_BUYER_ID=2 WHERE PATRON_ID=2;

UPDATE PATRON
SET BUYER_BUYER_ID=3 WHERE PATRON_ID=3;

--Play Listing
SELECT * FROM PLAY;

--Program For Romeo And Juliet
--Cast
SELECT FIRST_NAME, LAST_NAME, CHARACTER
FROM MEMBERS, CAST
WHERE MEMBERS.MEMBERS_ID=CAST.MEMBERS_ID
AND CAST_ID in (SELECT CAST_ID FROM CAST_IN WHERE PRODUCTION_ID=2);
--Credit
SELECT FIRST_NAME, LAST_NAME, JOB
FROM MEMBERS, JOB, WORKING_MEM
WHERE (MEMBERS.MEMBERS_ID=WORKING_MEM.MEMBERS_ID AND
JOB.JOB_ID=WORKING_MEM.JOB_ID)
AND JOB.PRODUCTION_PRODUCTION_ID=2;
--Sponsors
SELECT NAME
FROM SPONSOR 
WHERE SPONSOR_ID in (SELECT SPONSOR_ID FROM SPONSORED_BY WHERE PRODUCTION_ID=2);

--Report of Patrons

--Ticket Sales Report
SELECT SEATNUM, PRICE
FROM TICKET
WHERE PRODUCTION_PRODUCTION_ID=1
and SALE_INVOICE_NUMBER is not NULL;

--Admission Ticket

--Member Dues FOR 2016
SELECT FIRST_NAME, LAST_NAME, PHONE, EMAIL, STREET, CITY, STATE, ZIP
FROM MEMBERS
WHERE MEMBERS_ID in 
(SELECT MEMBERS_ID FROM DUES WHERE PAID_FULL=0 and YEAR=2016);
